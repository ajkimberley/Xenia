...
using Modules.Bookings.Endpoints.RequestResponse;

namespace Modules.Bookings.Endpoints.Controllers;
...
public class BookingsController(ISender mediator) : ControllerBase
{
    ...
    [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(object))] // update
